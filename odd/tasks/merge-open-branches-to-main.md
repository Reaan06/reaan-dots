...
4. Delete local and origin topic branches only after confirming their work is integrated; preserve `main`. (pending)
...
- Expected branch scope before publishing: main contains 21 commits ahead of and 0 behind `origin/main`; net tree difference is `tests/test_codex_usage.py` (+142 lines).
